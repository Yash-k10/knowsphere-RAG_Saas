...
def generate_join_code(prefix: str = "KS") -> str:
    """Generates an unambiguous 6-character uppercase alphanumeric workspace join code."""
...
class Tenant(Base):
    ...
    join_code: Mapped[str] = mapped_column(String(32), unique=True, index=True, default=generate_join_code, nullable=False)
